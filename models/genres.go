...
var GenreWhere = struct {
	...
	Name: whereHelpernull_String{field: "\"genres\".\"name\""},
}
...
func (r *genreR) GetMovieGenres() MovieGenreSlice {
	if r == nil {
		return nil
	}
...
var (
	...
	genreColumnsWithDefault    = []string{"id", "name"}
...
func (o *Genre) MovieGenres(mods ...qm.QueryMod) movieGenreQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"movie_genres\".\"genre_id\"=?", o.ID),
	)
...
func (genreL) LoadMovieGenres(ctx context.Context, e boil.ContextExecutor, singular bool, maybeGenre interface{}, mods queries.Applicator) error {
	var slice []*Genre
	var object *Genre
	...
	query := NewQuery(
		...
		qm.WhereIn(`movie_genres.genre_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *Genre) AddMovieGenres(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*MovieGenre) error {
	var err error
