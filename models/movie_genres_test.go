...
func testMovieGenresExists(t *testing.T) {
	...
	e, err := MovieGenreExists(ctx, tx, o.ID)
	if err != nil {
...
func testMovieGenresFind(t *testing.T) {
	...
	movieGenreFound, err := FindMovieGenre(ctx, tx, o.ID)
	if err != nil {
		t.Error(err)
	}
...
func movieGenreBeforeInsertHook(ctx context.Context, e boil.ContextExecutor, o *MovieGenre) error {
	*o = MovieGenre{}
	return nil
}

func movieGenreAfterInsertHook(ctx context.Context, e boil.ContextExecutor, o *MovieGenre) error {
	*o = MovieGenre{}
	return nil
}

func movieGenreAfterSelectHook(ctx context.Context, e boil.ContextExecutor, o *MovieGenre) error {
	*o = MovieGenre{}
	return nil
}

func movieGenreBeforeUpdateHook(ctx context.Context, e boil.ContextExecutor, o *MovieGenre) error {
	*o = MovieGenre{}
	return nil
}

func movieGenreAfterUpdateHook(ctx context.Context, e boil.ContextExecutor, o *MovieGenre) error {
	*o = MovieGenre{}
	return nil
}

func movieGenreBeforeDeleteHook(ctx context.Context, e boil.ContextExecutor, o *MovieGenre) error {
	*o = MovieGenre{}
	return nil
}

func movieGenreAfterDeleteHook(ctx context.Context, e boil.ContextExecutor, o *MovieGenre) error {
	*o = MovieGenre{}
	return nil
}

func movieGenreBeforeUpsertHook(ctx context.Context, e boil.ContextExecutor, o *MovieGenre) error {
	*o = MovieGenre{}
	return nil
}

func movieGenreAfterUpsertHook(ctx context.Context, e boil.ContextExecutor, o *MovieGenre) error {
	*o = MovieGenre{}
	return nil
}

func testMovieGenresHooks(t *testing.T) {
	t.Parallel()
	...
	seed := randomize.NewSeed()
	if err = randomize.Struct(seed, o, movieGenreDBTypes, false); err != nil {
		t.Errorf("Unable to randomize MovieGenre object: %s", err)
	}

	AddMovieGenreHook(boil.BeforeInsertHook, movieGenreBeforeInsertHook)
	...
	movieGenreBeforeInsertHooks = []MovieGenreHook{}

	AddMovieGenreHook(boil.AfterInsertHook, movieGenreAfterInsertHook)
	...
	movieGenreAfterInsertHooks = []MovieGenreHook{}

	AddMovieGenreHook(boil.AfterSelectHook, movieGenreAfterSelectHook)
	...
	movieGenreAfterSelectHooks = []MovieGenreHook{}

	AddMovieGenreHook(boil.BeforeUpdateHook, movieGenreBeforeUpdateHook)
	...
	movieGenreBeforeUpdateHooks = []MovieGenreHook{}

	AddMovieGenreHook(boil.AfterUpdateHook, movieGenreAfterUpdateHook)
	...
	movieGenreAfterUpdateHooks = []MovieGenreHook{}

	AddMovieGenreHook(boil.BeforeDeleteHook, movieGenreBeforeDeleteHook)
	...
	movieGenreBeforeDeleteHooks = []MovieGenreHook{}

	AddMovieGenreHook(boil.AfterDeleteHook, movieGenreAfterDeleteHook)
	...
	movieGenreAfterDeleteHooks = []MovieGenreHook{}

	AddMovieGenreHook(boil.BeforeUpsertHook, movieGenreBeforeUpsertHook)
	...
	movieGenreBeforeUpsertHooks = []MovieGenreHook{}

	AddMovieGenreHook(boil.AfterUpsertHook, movieGenreAfterUpsertHook)
	...
	movieGenreAfterUpsertHooks = []MovieGenreHook{}
}
...
func testMovieGenreToOneGenreUsingGenre(t *testing.T) {
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	seed := randomize.NewSeed()
	if err := randomize.Struct(seed, &local, movieGenreDBTypes, false, movieGenreColumnsWithDefault...); err != nil {
		t.Errorf("Unable to randomize MovieGenre struct: %s", err)
	}
	if err := randomize.Struct(seed, &foreign, genreDBTypes, false, genreColumnsWithDefault...); err != nil {
	...
	check, err := local.Genre().One(ctx, tx)
	if err != nil {
		t.Fatal(err)
	}
	...
	if err = local.L.LoadGenre(ctx, tx, false, (*[]*MovieGenre)(&slice), nil); err != nil {
		t.Fatal(err)
	}
	if local.R.Genre == nil {
		t.Error("struct should have been eager loaded")
	}

	local.R.Genre = nil
	if err = local.L.LoadGenre(ctx, tx, true, &local, nil); err != nil {
		t.Fatal(err)
	}
	if local.R.Genre == nil {
		t.Error("struct should have been eager loaded")
...
func testMovieGenreToOneSetOpGenreUsingGenre(t *testing.T) {
	var err error
	...
	if err = randomize.Struct(seed, &b, genreDBTypes, false, strmangle.SetComplement(genrePrimaryKeyColumns, genreColumnsWithoutDefault)...); err != nil {
		t.Fatal(err)
	}
	if err = randomize.Struct(seed, &c, genreDBTypes, false, strmangle.SetComplement(genrePrimaryKeyColumns, genreColumnsWithoutDefault)...); err != nil {
		t.Fatal(err)
	}
	...
	for i, x := range []*Genre{&b, &c} {
		err = a.SetGenre(ctx, tx, i != 0, x)
		if err != nil {
			t.Fatal(err)
		}
		...
		if a.GenreID != x.ID {
			t.Error("foreign key was wrong value", a.GenreID)
		}

		zero := reflect.Zero(reflect.TypeOf(a.GenreID))
		reflect.Indirect(reflect.ValueOf(&a.GenreID)).Set(zero)
		...
		if a.GenreID != x.ID {
			t.Error("foreign key was wrong value", a.GenreID, x.ID)
		}
	}
}
...
var (
	movieGenreDBTypes = map[string]string{`ID`: `integer`, `MovieID`: `integer`, `GenreID`: `integer`}
	_                 = bytes.MinRead
)
