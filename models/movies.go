...
type Movie struct {
	...
	IsAdult          bool         `boil:"is_adult" json:"is_adult" toml:"is_adult" yaml:"is_adult"`
	Budget           null.Float64 `boil:"budget" json:"budget,omitempty" toml:"budget" yaml:"budget,omitempty"`
	Homepage         null.String  `boil:"homepage" json:"homepage,omitempty" toml:"homepage" yaml:"homepage,omitempty"`
	ImdbID           null.String  `boil:"imdb_id" json:"imdb_id,omitempty" toml:"imdb_id" yaml:"imdb_id,omitempty"`
	...
	Popularity       null.Float64 `boil:"popularity" json:"popularity,omitempty" toml:"popularity" yaml:"popularity,omitempty"`
	PosterPath       null.String  `boil:"poster_path" json:"poster_path,omitempty" toml:"poster_path" yaml:"poster_path,omitempty"`
	ReleaseDate      null.Time    `boil:"release_date" json:"release_date,omitempty" toml:"release_date" yaml:"release_date,omitempty"`
	Revenue          null.Float64 `boil:"revenue" json:"revenue,omitempty" toml:"revenue" yaml:"revenue,omitempty"`
	Runtime          null.Float64 `boil:"runtime" json:"runtime,omitempty" toml:"runtime" yaml:"runtime,omitempty"`
	...
	VoteAverage      null.Float64 `boil:"vote_average" json:"vote_average,omitempty" toml:"vote_average" yaml:"vote_average,omitempty"`
...
var MovieWhere = struct {
	ID               whereHelperint
	IsAdult          whereHelperbool
	Budget           whereHelpernull_Float64
	...
	Popularity       whereHelpernull_Float64
	PosterPath       whereHelpernull_String
	ReleaseDate      whereHelpernull_Time
	Revenue          whereHelpernull_Float64
	Runtime          whereHelpernull_Float64
	Tagline          whereHelpernull_String
	Title            whereHelpernull_String
	VideoURL         whereHelpernull_String
	VoteAverage      whereHelpernull_Float64
	VoteCount        whereHelpernull_Int
}{
	ID:               whereHelperint{field: "\"movies\".\"id\""},
	IsAdult:          whereHelperbool{field: "\"movies\".\"is_adult\""},
	Budget:           whereHelpernull_Float64{field: "\"movies\".\"budget\""},
	Homepage:         whereHelpernull_String{field: "\"movies\".\"homepage\""},
	ImdbID:           whereHelpernull_String{field: "\"movies\".\"imdb_id\""},
	OriginalTitle:    whereHelpernull_String{field: "\"movies\".\"original_title\""},
	OriginalLanguage: whereHelpernull_String{field: "\"movies\".\"original_language\""},
	Overview:         whereHelpernull_String{field: "\"movies\".\"overview\""},
	Popularity:       whereHelpernull_Float64{field: "\"movies\".\"popularity\""},
	PosterPath:       whereHelpernull_String{field: "\"movies\".\"poster_path\""},
	ReleaseDate:      whereHelpernull_Time{field: "\"movies\".\"release_date\""},
	Revenue:          whereHelpernull_Float64{field: "\"movies\".\"revenue\""},
	Runtime:          whereHelpernull_Float64{field: "\"movies\".\"runtime\""},
	Tagline:          whereHelpernull_String{field: "\"movies\".\"tagline\""},
	Title:            whereHelpernull_String{field: "\"movies\".\"title\""},
	VideoURL:         whereHelpernull_String{field: "\"movies\".\"video_url\""},
	VoteAverage:      whereHelpernull_Float64{field: "\"movies\".\"vote_average\""},
	VoteCount:        whereHelpernull_Int{field: "\"movies\".\"vote_count\""},
}
...
var (
	movieAllColumns            = []string{"id", "is_adult", "budget", "homepage", "imdb_id", "original_title", "original_language", "overview", "popularity", "poster_path", "release_date", "revenue", "runtime", "tagline", "title", "video_url", "vote_average", "vote_count"}
	movieColumnsWithoutDefault = []string{"is_adult"}
	movieColumnsWithDefault    = []string{"id", "budget", "homepage", "imdb_id", "original_title", "original_language", "overview", "popularity", "poster_path", "release_date", "revenue", "runtime", "tagline", "title", "video_url", "vote_average", "vote_count"}
...
func (o *Movie) MovieGenres(mods ...qm.QueryMod) movieGenreQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"movie_genres\".\"movie_id\"=?", o.ID),
	)
...
func (movieL) LoadMovieGenres(ctx context.Context, e boil.ContextExecutor, singular bool, maybeMovie interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`movie_genres`),
		qm.WhereIn(`movie_genres.movie_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if err != nil {
		return errors.Wrap(err, "failed to eager load movie_genres")
	}

	var resultSlice []*MovieGenre
	if err = queries.Bind(results, &resultSlice); err != nil {
		return errors.Wrap(err, "failed to bind eager loaded slice movie_genres")
	}

	if err = results.Close(); err != nil {
		return errors.Wrap(err, "failed to close results in eager load on movie_genres")
	}
	if err = results.Err(); err != nil {
		return errors.Wrap(err, "error occurred during iteration of eager loaded relations for movie_genres")
	}
