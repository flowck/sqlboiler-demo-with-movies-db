...
var (
	movieDBTypes = map[string]string{`ID`: `integer`, `IsAdult`: `boolean`, `Budget`: `double precision`, `Homepage`: `character varying`, `ImdbID`: `character varying`, `OriginalTitle`: `character varying`, `OriginalLanguage`: `character varying`, `Overview`: `text`, `Popularity`: `double precision`, `PosterPath`: `character varying`, `ReleaseDate`: `date`, `Revenue`: `double precision`, `Runtime`: `double precision`, `Tagline`: `character varying`, `Title`: `character varying`, `VideoURL`: `character varying`, `VoteAverage`: `double precision`, `VoteCount`: `integer`}
	_            = bytes.MinRead
)
